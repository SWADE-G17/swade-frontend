  ...
  return (
    <aside className="flex w-72 shrink-0 flex-col border-r border-zinc-200 bg-white">
      ...
      <div className="px-4 pb-4">
        <div className="flex items-center gap-3  border border-zinc-200 bg-white p-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#5D5FEF] text-white">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
